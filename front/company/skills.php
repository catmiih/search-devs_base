...
<title>Search Devs - Cadastro de projeto</title>
...
<?php require_once '../functions/proj-skill.php'; ?>
        ...
        <div class="container text" style="width: 100%; height: 100vh;">
            <center>
                <div id="campo1">
                    ...
                    <h2>Selecione as habilidades necessárias.</h2>
                </div>
                ...
                <form method="post" name="skills-form" action="../functions/proj-skill.php">
                    <center>
