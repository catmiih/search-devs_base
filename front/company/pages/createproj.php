                ...
                <div class="row high">
                    <div class="col">
                        <div class="row input">
                            ...
                            <input type="text" class="col form-control" name="username" id="" maxlength="25" minlength="5">

                        </div>

                        <div class="row input">
                            <p class="col-1 label"> Data de início:</p>
                            <input type="date" class="col form-control" name="office" id="" maxlength="25" minlength="5">
                        </div>
                    </div>

                    <div class="col">
                        <div class="row input">
                            <p class="col-1 label">Pagamento por hora:</p>
                            <input type="text" class="col form-control" name="name" id="" minlength="5">

                        </div>

                        <div class="row input">
                            <p class="col-1 label"> Data final:</p>
                            <input type="date" class="col form-control" name="cell" id="" maxlength="25" minlength="5">
                        </div>
                    </div>
                </div>
            </div>
