...
<div class="perfil">
        ...
        <div id="profile_banner">
            ...
            <div id="profile">
                <div class="profile_pic">
                    <img src="https://wedologos.bladecdn.net/wp-content/uploads/2014/09/android-logo-300x218.jpg" >
                </div>
    ...
    <div class="skills">
        <div class="row evaluation justify-content-between">
            ...
            <h2 style="font-weight:700" class="col">Especializações:</h2>
    ...
    <div class="row feed">
        <div class="col info">
            ...
            <div class="row input">
                <p class="col label">Representante:</p>
